                    ...
                    <div class="card-body">
                        <div class="main-content-label mg-b-5">
                            <div class="form-group">
                                <p>اسم الصلاحية :</p>
                                <input type="text" name="name" placeholder="Name" class="form-control" id="" value="{{$role->name}}">
                            </div>
                        </div>
                        <div class="row">
                            <!-- col -->
                                        ...
                                        <ul>
                                            <li>
                                                @foreach($permission as $value)
                                                    <label>
                                                        <input type="checkbox" name="permission[]" @checked(in_array($value->id, $rolePermissions)) value="{{$value->name}}" id="" class="name">
