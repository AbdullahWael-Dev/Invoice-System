    ...
    <div class="row row-sm">
        <div class="col-md-12 col-lg-12 col-xl-7">
            <div class="card">
                ...
                <div class="card-body" style="width: 90%">
                    <canvas id="invoiceChart" width="350" height="200"></canvas>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12 col-xl-5">
            <div class="card card-dashboard-map-one">
                ...
                <canvas id="invoiceChart2" width="350" height="200"></canvas>
            </div>
        </div>
    </div>
    <!-- row closed -->
...
@section('js')
        ...
        var invoiceChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    borderColor: ['#c0392b', '#2e7d32', '#e67e22'],
                    borderWidth: 1
                }]
            },
            options: {
                ...
                plugins: {
                    legend: {
                        rtl: true,
                        align: 'start', // Moves the legend to the right for RTL
                    },
                    tooltip: {
                        rtl: true, // Ensures tooltips are RTL
                    }
                },
                scales: {
                    y: {
    ...
    <script>
        ...
        var invoiceChart2 = new Chart(ctx, {
            type: 'pie',
            data: {
                labels: ['الفواتير الغير المدفوعة', 'الفواتير المدفوعة', 'الفواتير المدفوعة جزئيا'],
                datasets: [{
